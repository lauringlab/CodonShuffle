...
For more information or citation for CodonShuffle package access:

* Jorge D M M, Mills R E, Lauring A S, CodonShuffle: a tool for generating and analyzing synonymously mutated sequences. <a href="http://dx.doi.org/10.1093/ve/vev012" target="_blank">Virus Evolution</a>, 2015, 1(1): vev012 
...
6. Select a single permutation script to use (3n, dn23, dn31, dn231)
